...
import { FaUsers, FaTools, FaShieldAlt, FaPalette, FaChartBar, FaPlus, FaEdit, FaTrash, FaDownload, FaExclamationTriangle, FaCheck, FaHistory, FaCog, FaUser } from 'react-icons/fa';
                                    ...
                                    <AlertBanner key={alert.id} type={alert.priority === 'high' ? 'error' : 'warning'}>
                                        ...
                                        <ButtonGroup>
                                            ...
                                            <PrimaryButton onClick={() => {
                                                ...
                                                const object = objects.find(obj => obj.id === alert.objectId);
                                                if (object) {
                                        ...
                                        <ButtonGroup>
                                            ...
                                            <PrimaryButton onClick={() => {
                                                ...
                                                if (alert.title.includes('suppression')) {
                                                    handleDeleteObject(alert.objectId);
                                                }
                                                setAlerts(alerts.map(a => 
                                                    a.id === alert.id ? { ...a, status: 'approved' } : a
                                                ));
                                            }}>
                                                Approuver
                                            </PrimaryButton>
