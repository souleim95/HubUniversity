...
const CampusMap = () => {
  ...
  const getObjectPosition = (object, category, index, total) => {
    ...
    else if(category.name === "Équipements salle_101"){
      buildingKey = "Salle info";
    }
    else if (category.name === "Objets parking & extérieur") {
      buildingKey = "Parking";
      // Les objets de parking sont généralement extérieurs
      isInterior = false;
      
      // Spécificités pour certains objets extérieurs
      if (object.id.includes('cam')) {
        // Caméras aux entrées
        const camPositions = [
          {x: 300, y: 200}, {x: 300, y: 400}, 
          {x: 700, y: 200}, {x: 700, y: 400},
          {x: 750, y: 550}, {x: 950, y: 550}
        ];
        const pos = camPositions[index % camPositions.length];
        return { x: pos.x, y: pos.y, interior: false };
      }
      else if (object.id.includes('light')) {
        // Éclairages extérieurs
        const lightPositions = [
          {x: 100, y: 200}, {x: 300, y: 200}, {x: 500, y: 200}, {x: 700, y: 200}, {x: 900, y: 200},
          {x: 100, y: 400}, {x: 300, y: 400}, {x: 500, y: 400}, {x: 700, y: 400}, {x: 900, y: 400}
        ];
  ...
  const getObjectIcon = (object) => {
    if (object.id.includes('light') || object.id.includes('eclairage')) return '💡';
    else if (object.id.includes('cam')) return '📹';
    else if (object.id.includes('capteur') || object.id.includes('detecteur')) return '📡';
    else if (object.id.includes('parking') || object.id.includes('place')) return '🅿️';
    else if (object.id.includes('alarme') || object.id.includes('urgence')) return '🚨';
    else if (object.id.includes('ordi') || object.id.includes('info')) return '💻';
    else if (object.id.includes('biblio')) return '📚';
    else if (object.id.includes('amphi')) return '🎭';
    else if (object.id.includes('gym')) return '🏀';
    else if (object.id.includes('labo') || object.id.includes('chim')) return '🧪';
    else if (object.id.includes('food') || object.id.includes('ref')) return '🍽️';
    else if (object.id.includes('cafe')) return '☕';
    else if (object.id.includes('score')) return '💯';
    else if (object.id.includes('grille')) return '🔓';
    else if (object.id.includes('porte')) return '🚪';
    else if (object.id.includes('borne')) return '🧾';
    return '❓';
  };
            ...
            >
              ...
              >
                ...
                <rect 
                  ...
                  strokeWidth="2" 
                  onClick={() => setSelectedBuilding(selectedBuilding === "École" ? null : "École")}
                ...
                <rect 
                  ...
                  strokeWidth="2"
                  onClick={() => setSelectedBuilding(selectedBuilding === "Gymnase" ? null : "Gymnase")} 
                  style={{ cursor: 'pointer' }}
                />
                ...
                <rect 
                  ...
                  strokeWidth="2"
                  onClick={() => setSelectedBuilding(selectedBuilding === "Bibliothèque" ? null : "Bibliothèque")}
                  style={{ cursor: 'pointer' }}
                />
                ...
                <rect 
                  ...
                  strokeWidth="2"
                  onClick={() => setSelectedBuilding(selectedBuilding === "Réfectoire" ? null : "Réfectoire")}
                  style={{ cursor: 'pointer' }}
                />
                ...
                <rect 
                  ...
                  strokeWidth="2"
                  onClick={() => setSelectedBuilding(selectedBuilding === "Laboratoire" ? null : "Laboratoire")}
                  style={{ cursor: 'pointer' }}
                />
                ...
                <rect 
                  ...
                  strokeWidth="2"
                  onClick={() => setSelectedBuilding(selectedBuilding === "Salle info" ? null : "Salle info")}
                  style={{ cursor: 'pointer' }}
                />
                ...
                <rect 
                  ...
                  strokeWidth="2"
                  onClick={() => setSelectedBuilding(selectedBuilding === "Amphithéâtre" ? null : "Amphithéâtre")}
                  style={{ cursor: 'pointer' }}
                />
                ...
                <rect 
                  ...
                  onClick={() => setSelectedBuilding(selectedBuilding === "Parking" ? null : "Parking")}
                  style={{ cursor: 'pointer' }}
                />
